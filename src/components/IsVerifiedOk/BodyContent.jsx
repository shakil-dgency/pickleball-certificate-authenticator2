		...
		<div>
			...
			<div className="g__container flex flex-col sm:flex-row gap-5 pb-[120px]">
				<div className="flex-1 space-y-[50px] sm:border-r-[1px] pt-[50px] ">
					...
					<div className="">
						...
						<div className="flex items-center gap-4 pt-3">
							<Image src={post?.signed_by_picture} height={100} width={100} alt="" quality={65}  priority className="h-[100px] w-[100px] object-cover flex-none" />
				...
				<div className="flex-1 flex flex-col items-center pt-[50px]">
					...
					<div className="max-w-[500px]">
						<Image src={post?.item_images} height={550} width={500} quality={65}  priority className="h-[550px] w-auto object-cover" alt="" />
					</div>
